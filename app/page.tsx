...
function Dashboard() {
  ...
  function decide(decision: "accepted" | "modified" | "rejected") {
    setToast(decision === "accepted" ? "Claim CRM Updated & Payout Approved" : decision === "modified" ? "Recommendation sent to adjuster for modification" : "Recommendation rejected; no CRM update made");
  }
